# Aesthetic Skills Catalog

Each entry maps to `aesthetics/{slug}.md` containing tokens, components, accessibility rules, and quality gates for that visual style.
